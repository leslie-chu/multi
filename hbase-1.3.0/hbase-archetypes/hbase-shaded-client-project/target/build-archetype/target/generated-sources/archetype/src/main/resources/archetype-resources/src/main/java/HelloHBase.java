 ...
 * refer to https://hbase.apache.org/book.html${symbol_pound}quickstart
 */
public final class HelloHBase {
  ...
  public static void main(final String[] args) throws IOException {
    ...
    /**
     * ConnectionFactory${symbol_pound}createConnection() automatically looks for
    ...
    try (Connection connection = ConnectionFactory.createConnection();
      ...
      System.out.println("${symbol_escape}n*** Hello HBase! -- Connection has been "
              + "established via Zookeeper!!${symbol_escape}n");
  ...
  /**
   * Invokes Admin${symbol_pound}createNamespace and Admin${symbol_pound}createTable to create a namespace
  ...
  /**
   * Invokes Table${symbol_pound}put to store a row (with two new columns created 'on the
   * fly') into the table.
   *
  ...
  static void putRowToTable(final Table table) throws IOException {
    ...
    System.out.println("Row [" + Bytes.toString(MY_ROW_ID)
            + "] was put into Table ["
            + table.getName().getNameAsString() + "] in HBase;${symbol_escape}n"
  ...
  /**
   * Invokes Table${symbol_pound}get and prints out the contents of the retrieved row.
   *
  ...
  /**
   * Invokes Table${symbol_pound}delete to delete test data (i.e. the row)
   *
   * @param table Standard Table object
  ...
  /**
   * Invokes Admin${symbol_pound}disableTable, Admin${symbol_pound}deleteTable, and Admin${symbol_pound}deleteNamespace to
